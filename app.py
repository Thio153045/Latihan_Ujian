...
if user["role"] == "guru":
    pages = [
        st.Page("app_pages/1_Upload_Soal.py", title="Upload Soal", icon="📤", default=True),
        st.Page("app_pages/3_Kelola_Siswa.py", title="Kelola Siswa", icon="👩‍🏫"),
        st.Page("app_pages/5_Analisa_Jawaban.py", title="Analisa Jawaban", icon="🧮"),
    ]
else:
    pages = [
        st.Page("app_pages/2_Kerjakan_Soal.py", title="Kerjakan Soal", icon="📝", default=True),
        st.Page("app_pages/4_Riwayat_Nilai.py", title="Riwayat Nilai", icon="📊"),
    ]
